...
Our project *Firefly Catcher* is inspired by both interactive games and visual storytelling.
...
Our project is built using p5.js and combines several techniques to create an interactive system.

We use **Perlin noise** to to control the movement of fireflies.....
...
Each team member was responsible for one core mechanic:
...
**User Input Mechanic – Yurui Li**  
  Uses mouse movement and double-clicking for catching fireflies. Players must control their speed carefully, as moving too fast or too slow will scare them away.
...
Relevant sections in the code are commented to indicate where AI assistance was used.

---

## External References

We referred to the following sources for inspiration and technical guidance:
.......

These references influenced our approach to animation and system design. Any adapted techniques are also commented in the code.
